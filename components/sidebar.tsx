...
function Sidebar() {
  ...
  const menuOptions = (
    <>
      <NewDocumentButton />
      <div className='flex py-4 flex-col space-y-4 md:max-w-50'>
        {/**My Documents*/}
        ...
        {groupedData.owner.length === 0 ? (
          ...
          <>
            <h2 className="text-gray-900 font-semibold text-sm">My Documents</h2>
  ...
  return (
    <div className='p-2 md:p-5 bg-zinc-200 relative'>
